				...
				<div className="rate-content">
					...
					<ul>
						{this.state.pages.map((page, i) => {
							if (page.type === "draw") {
								return (
									<li key={page.playerId} onClick={() => {this.togglePageApproved(page.playerId)}}>
										<Drawing
										...
										<div className={`rating-indicator ${page.accepted ? "is-visible" : ""}`} />
									</li>
								);
							} else {
								return (
					...
					<Button className="is-dark" onClick={this.submitRating.bind(this)} text="Ok!" />
				</div>
			</div>
		);
	}
