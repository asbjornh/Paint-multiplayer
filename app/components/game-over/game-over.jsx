...
class Confetti extends mojs.CustomShape {
  getShape() {
    return "<path d='M38,12c-12.7,2.8-25.3,2.8-38,0V0c12.7,4.2,25.3,4.2,38,0V12z'></path>";
  }
}
...
class GameOver extends React.Component {
  ...
  componentDidMount() {
    ...
    burst.tune({
      x:
        this.players[0].getBoundingClientRect().left +
        0.5 * this.players[0].offsetWidth,
      y:
        this.players[0].getBoundingClientRect().top +
        0.5 * this.players[0].offsetHeight
    });
