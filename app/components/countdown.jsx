...
class Countdown extends React.Component {
	...
	render() {
		return (
			<div className={`countdown ${ this.state.currentTime < 11 ? this.state.currentTime < 6 ? "pulsate-crazy" : "pulsate-faster" : "" }`}>
					...
					<div className="countdown-circle">
						...
						>
							<circle
								...
								stroke="#FFFFFF"
								strokeDasharray="195"
								strokeDashoffset={Math.min(0, -195 * (this.state.currentTime / this.props.totalTime))}
								strokeWidth="12"
								cx="37"
								cy="37"
								r="31"
